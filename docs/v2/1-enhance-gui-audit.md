...
- The current minimum window is 880 × 760, below the approved 1400 × 880 Phase 1 minimum.
...
- The main window opens at 1400 × 880 and cannot shrink below that size.
...
- Initial and minimum window size are exactly 1400 × 880 logical pixels.
