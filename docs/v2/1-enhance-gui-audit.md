...
- The current minimum window is 880 × 760, below the approved 1536 × 1536 Phase 1 minimum.
...
- The main window opens at 1536 × 1536 and cannot shrink below that size.
...
- Initial and minimum window size are exactly 1536 × 1536 logical pixels.
